const zh = {
    ...
    otherEmailDesc: '使用 Cloudflare 原生透明转发，与 Resend 邮件发送设置无关；目标邮箱必须先在 Cloudflare 中验证。',
    ...
    personalOtherEmailDesc: '仅透明转发你收到的邮件，与系统的 Resend 发信设置无关；目标邮箱必须先在 Cloudflare 中验证。',
