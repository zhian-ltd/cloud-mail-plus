const en = {
    ...
    otherEmailDesc: 'Uses Cloudflare native transparent forwarding independently of the Resend sending setting. Destinations must first be verified in Cloudflare.',
    ...
    personalOtherEmailDesc: 'Transparently forwards only mail received by you, independently of the system Resend sending setting. Destinations must first be verified in Cloudflare.',
