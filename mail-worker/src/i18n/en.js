const en = {
	...
	autheliaSsoDisabled: 'Authelia SSO is disabled',
	autheliaSsoMissingConfig: 'Authelia SSO configuration is incomplete',
	autheliaSsoMissingOpenidScope: 'Authelia SSO scopes must include openid',
	autheliaSsoUnsupportedClientAuth: 'The Authelia client authentication method is not supported',
	autheliaSsoPkceUnsupported: 'Authelia does not advertise S256 PKCE support',
	autheliaSsoProviderError: 'Authelia rejected the sign-in: {{msg}}',
	autheliaSsoCodeMissing: 'The SSO callback is missing the authorization code',
	autheliaSsoStateInvalid: 'The SSO login state expired; please sign in again',
	autheliaSsoDiscoveryFailed: 'Unable to load the Authelia OIDC configuration',
	autheliaSsoDiscoveryInvalid: 'The Authelia OIDC configuration contains an invalid endpoint',
	autheliaSsoIssuerMismatch: 'The Authelia OIDC issuer does not match',
	autheliaSsoTokenExchangeFailed: 'Authelia authorization code exchange failed',
	autheliaSsoTokenMissing: 'Authelia did not return the required tokens',
	autheliaSsoTokenTypeInvalid: 'Authelia returned an unsupported token type',
	autheliaSsoIdTokenInvalid: 'Authelia ID Token validation failed',
	autheliaSsoNonceInvalid: 'Authelia ID Token nonce validation failed',
