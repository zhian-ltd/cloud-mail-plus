const zh = {
	...
	autheliaSsoDisabled: 'Authelia SSO 未启用',
	autheliaSsoMissingConfig: 'Authelia SSO 配置不完整',
	autheliaSsoMissingOpenidScope: 'Authelia SSO 必须包含 openid scope',
	autheliaSsoUnsupportedClientAuth: 'Authelia 客户端认证方式不受支持',
	autheliaSsoPkceUnsupported: 'Authelia 未公布 S256 PKCE 支持',
	autheliaSsoProviderError: 'Authelia 拒绝登录：{{msg}}',
	autheliaSsoCodeMissing: 'SSO 回调缺少授权码',
	autheliaSsoStateInvalid: 'SSO 登录状态已失效，请重新登录',
	autheliaSsoDiscoveryFailed: '无法读取 Authelia OIDC 配置',
	autheliaSsoDiscoveryInvalid: 'Authelia OIDC 配置包含无效端点',
	autheliaSsoIssuerMismatch: 'Authelia OIDC Issuer 不匹配',
	autheliaSsoTokenExchangeFailed: 'Authelia 授权码兑换失败',
	autheliaSsoTokenMissing: 'Authelia 未返回所需令牌',
	autheliaSsoTokenTypeInvalid: 'Authelia 返回了不支持的令牌类型',
	autheliaSsoIdTokenInvalid: 'Authelia ID Token 验证失败',
	autheliaSsoNonceInvalid: 'Authelia ID Token nonce 验证失败',
